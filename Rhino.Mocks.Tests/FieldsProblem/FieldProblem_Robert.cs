...
namespace Rhino.Mocks.Tests.FieldsProblem
{
	...
	public class FieldProblem_Robert
	{
		...
		public void CorrectResultForExpectedWhenUsingTimes()
		{
			...
			Assert1.Throws<ExpectationViolationException>("IView.RedrawDisplay(\"blah\"); Expected #4, Actual #5.",
			                                             () =>
			                                             {
		...
		public void CorrectResultForExpectedWhenUsingTimesWithRange()
		{
			...
			Assert1.Throws<ExpectationViolationException>("IView.RedrawDisplay(\"blah\"); Expected #3 - 4, Actual #5.",
			                                             () =>
			                                             {
			                                             	using (mocks.Playback())
			                                             	{

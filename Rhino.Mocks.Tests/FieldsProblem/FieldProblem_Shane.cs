namespace Rhino.Mocks.Tests.FieldsProblem
{
	...
	public class FieldProblem_Shane
	{
		...
		public void WillMerge_UnorderedRecorder_WhenRecorderHasSingleRecorderInside()
		{
			...
			Assert1.Throws<ExpectationViolationException>("Unordered method call! The expected call is: 'Ordered: { ICustomer.get_Id(); }' but was: 'ICustomer.set_IsPreferred(True);'", () =>
			{
